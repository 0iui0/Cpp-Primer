...
> 为13.1.1节exercise13.5中的 HasPtr 类编写赋值运算符。类似拷贝构造函数，你的赋值运算符应该将对象拷贝到ps指向的位置。
...
> 为前面exercise中的 HasPtr 类添加一个析构函数。
...
> 比较上一节exercise中你编写的拷贝控制成员和这一节中的代码。确定你理解了你的代码和我们的代码之间的差异。
...
Ex13.34 : [h](ex13_34.h) | [cpp](ex13_34.cpp)
...
Ex13.36 : [h](ex13_34.h) | [cpp](ex13_34.cpp)

> 设计并实现对应的 Folder 类。此类应该保存一个指向 Folder 中包含  Message 的 set。

Ex13.37 : [h](ex13_34.h) | [cpp](ex13_34.cpp)
...
Ex13.39 : [hpp](ex13_39.h) | [cpp](ex13_39.cpp)

> 编写你自己版本的 StrVec，包括自己版本的 reserve、capacity 和 resize。

Ex13.40: [hpp](ex13_39.h) | [cpp](ex13_39.cpp)
...
[hpp](ex13_44.h) | [cpp](ex13_44.cpp) | [Test](ex13_44_main.cpp)
...
Ex13.47 : [hpp](ex13_44.h) | [cpp](ex13_44.cpp) 

> 对你在exercise13.44中定义的 String类，为它的拷贝构造函数和拷贝赋值运算符添加一条语句，在每次函数执行时打印一条信息。

## [ex13.48](ex13_44_main.cpp)
...
> 在你的 String 类的移动操作中添加打印语句，并重新运行13.6.1节的exercise13.48中的程序，它使用了一个vector<String>，观察什么时候会避免拷贝。
...
Ex13.53 : [hpp](ex13_53.h) | [cpp](ex13_53.cpp) 
