...
namespace jj00 {
    ...
    void test_misc() {
        ...
        cout << "MyString(zoo) == MyString(hello) ==> " << (MyString("zoo") == MyString("hello")) << endl;    //0
        cout << "MyStrNoMove(zoo) < MyStrNoMove(hello) ==> " << (MyStrNoMove("zoo") < MyStrNoMove("hello"))
             << endl;     //0
        cout << "MyStrNoMove(zoo) == MyStrNoMove(hello) ==> " << (MyStrNoMove("zoo") == MyStrNoMove("hello"))
             << endl;     //0
...
namespace jj06 {
    void test_multiset(long &value) {
        ...
        cout << "milli-seconds : " << (clock() - timeStart) << endl;
        cout << "multiset.ASIZE()= " << c.size() << endl;
...
namespace jj07 {
    void test_multimap(long &value) {
        ...
        cout << "milli-seconds : " << (clock() - timeStart) << endl;
        cout << "multimap.ASIZE()= " << c.size() << endl;
...
namespace jj09 {
    void test_unordered_multimap(long &value) {
        ...
        cout << "milli-seconds : " << (clock() - timeStart) << endl;
        cout << "unordered_multimap.ASIZE()= " << c.size() << endl;
...
namespace jj15 {
    void test_unordered_set(long &value) {
        ...
        cout << "milli-seconds : " << (clock() - timeStart) << endl;
        cout << "unordered_set.ASIZE()= " << c.size() << endl;
...
namespace jj16 {
    void test_unordered_map(long &value) {
        ...
        cout << "milli-seconds : " << (clock() - timeStart) << endl;
        cout << "unordered_map.ASIZE()= " << c.size() << endl;    //357913941
...
namespace jj25 {
    void test_components_sizeof() {
        ...
        cout << "sizeof(unordered_map<int,int>::iterator)= " << sizeof(unordered_map<int, int>::iterator)
             << endl;    //4
        cout << "sizeof(unordered_multiset<int>::iterator)= " << sizeof(unordered_multiset<int>::iterator)
             << endl;    //4
        cout << "sizeof(unordered_multimap<int,int>::iterator)= " << sizeof(unordered_multimap<int, int>::iterator)
             << endl;    //4

        //allocators
        cout << "sizeof(      std::allocator<string>)=" << sizeof(std::allocator<string>)
             << endl;                        //1 (理論值 0)
